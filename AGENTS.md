...
All writing presented to the user — chat responses, PR descriptions, comments, documentation — must follow the plain language format defined in ISO 24495-1:2023. This only applies to language presented to the user; your regular reasoning method should be retained.
